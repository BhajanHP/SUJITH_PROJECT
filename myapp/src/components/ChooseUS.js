...
function ChooseUS(){
    return (
        <div className='chooseUS-container'>
            <h1 className='chooseUS-container-h1' style={{  fontWeight: 700 }}  data-aos="fade-up">Why Clients Trust Us</h1>
            {/* <h3 className='chooseUS-container-h2' style={{  fontWeight: 600 }}> Creativity That Delivers Results</h3> */}
            <p className='chooseUS-container-p' style={{  fontWeight: 600 }}  data-aos="fade-up">We craft designs that are not only beautiful but also staratigically impactful. Here is why client love working with us</p>
